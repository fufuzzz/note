...
# 逻辑运算的优先级: not > and > or
print(True or False and True)  # True or False
print(False or not False)   # False or True
...
# 逻辑与运算规则:
# 逻辑与运算:
# 只要有一个运算符是False,结果就是False;只有所有的运算数都是True,结果才是True
...
# 取值: 取第一个为True的值,如果所有的运算都是False,取最后一个运算数
